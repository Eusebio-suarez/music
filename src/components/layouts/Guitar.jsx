...
export const Guitar = () => {
  return (
    <div
      className='w-full flex relative justify-end items-center gap-10 text-white bg-cover bg-center min-h-[230px]'
      style={{ backgroundImage: `url(${guitarImg})` }}
    >
      <div className='flex gap-1.5 flex-col absolute w-[200px] right-4'>
